...
public class LzmaBench
{
	...
	static public int LzmaBenchmark(int numIterations, int dictionarySize) throws Exception
	{
		...
		com.ssmCore.tool.zip7.Compression.LZMA.Encoder encoder = new com.ssmCore.tool.zip7.Compression.LZMA.Encoder();
		com.ssmCore.tool.zip7.Compression.LZMA.Decoder decoder = new com.ssmCore.tool.zip7.Compression.LZMA.Decoder();
