...
@Service("SdkegretImpl")
@Scope("prototype")
public class EgretImpl implements I_Platform {
	private static final Logger log = LoggerFactory.getLogger(EgretImpl.class);
	private static final String URL_USERINFO = "https://api.egret-labs.org/v2/user/getInfo";
	...
	public UserBase logVerification(Map<String, Object> param, DataConf dSource) throws Exception {
		...
		String result = HttpRequest.PostFunction(URL_USERINFO, p);
		...
		ubase.pid = pid;
//		String head = HttpRequest.encodeImgageToBase64(new URL(user_Entity.data.pic));
//		if (head != null) {
