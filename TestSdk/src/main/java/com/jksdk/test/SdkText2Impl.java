...
@Service("Sdktest2Impl")
@Scope("prototype")
public class SdkText2Impl implements I_Platform{
	...
	public UserBase logVerification(Map<String, Object> param, DataConf dSource) throws Exception {
		...
		UserInfo userInfo = db.find(new Query(Criteria.where("account")
				.is((String)param.get("nickname"))
				.and("pid").is(param.get("pid")))
				,UserInfo.class);
