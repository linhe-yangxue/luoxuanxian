...
import com.ssmGame.module.activity.LimitGiftActivityImpl;

public class LimitGiftServlet extends AdvancedServlet {
	private static final long serialVersionUID = 1L;
	
	public LimitGiftServlet() {
		super(LimitGiftServlet.class);
	}
	...
	@FunUrl(value = I_DefMoudle.ACT_LIMIT_GIFT_BUY)
